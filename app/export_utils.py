...
def generate_csv_report(session_state, filename="CryptoLab_Report"):
    ...
    writer.writerow(["AES", "PASSED" if session_state.get("aes_ok") else "FAILED", "Original data correctly recovered" if session_state.get("aes_ok") else "Data mismatch"])
    writer.writerow(["DES", "PASSED" if session_state.get("des_ok") else "FAILED", "Original data correctly recovered" if session_state.get("des_ok") else "Data mismatch"])
    writer.writerow([])
